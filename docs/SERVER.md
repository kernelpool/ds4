...
thinking object, or a non-thinking model alias for direct answers. DeepSeek V4.1
renders the effort as a numeric budget (low 50, high 75, max 100); an integer
`reasoning_effort` between 1 and 100 sets it directly, and `--reasoning-effort N`
